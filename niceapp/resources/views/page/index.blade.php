...
@endforeach --}}
            ...
            <table class="table">
              ...
              <tbody>
                <tr class="d-flex border-top">
                  ...
                  <td class="col-2 col-sm-1" >0</td><html lang="en"><head>
    ...
    <meta name="csrf-token" content="cwgWQZHtxKIqljCpRlLaxVMJ7sm1U9aDIvlvQtZy">
      ...
      <div class="navigation-margin">
        <div class="toolbar layout-gt-sm-row d-flex ">
          <div class="inline logo">
            <a href="/">
              <img src="http://localhost:8000/img/mini.png">
            </a>
          </div>
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              <form method="POST" action="http://localhost:8000/login">
                  <input type="hidden" name="_token" value="cwgWQZHtxKIqljCpRlLaxVMJ7sm1U9aDIvlvQtZy">
...
</div>    <div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="registerModal" aria-hidden="true">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-header">
    ...
    <section class="flex">
      <div class="headline ">
        ...
        <div id="main-bg">
          <img src="http://localhost:8000/img/heic1501a.jpg">
        </div>
        <div class="to_feature">
        ...
        <div class="content-wrapper">
          ...
          <div class="headline-feature">
            <div class="cover-big">
              <img width="170px" src="http://localhost:8000/img/mini.png">
            </div>
            <div class="feature-desc">
              <div class="inline  data-content">
                <div class="row-tag">
            ...
            <div class="d-flex justify-content-center">
              ...
              <div class="service-col">
                <div class="service-top img-fluid">
                  ...
                  <img width="300" class="rounded-circle" height="300" src="http://localhost:8000/img/sqr26.png">
